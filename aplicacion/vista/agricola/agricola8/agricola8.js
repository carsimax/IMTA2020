...
async function Consultar() {
  ...
  if (OC !== "" && Est !== "" && Mun !== "" && Cultivo !== "" && Anio !== "") {
    ...
    data = "Accion=ConsultaAgricolaHistorica&modulo_id=8&anios=" + Anio.replace(/anioagricola_id/g, 'anio_id');
    ...
    $.ajax({
      ...
      success: async function (resp2) {
        ...
        $("#pantalla").append(
          ...
          //Titulo 6
          '<div class="col-sm-12">' +
          "<h5>Volumen (miles de m³)* por año agrícola.</h5>" +
          '<hr class="red">' +
          "</div>" +
          //Grafica6
          '<div class="col-sm-8">' +
        ...
        $.each(JSON.parse(resp2), function (index, item) {
          ...
          volumen.push(parseFloat(item.VOL).toFixed(2));
          t6.push([
            item.anio,
            numeral(parseFloat(item.VOL).toFixed(2)).format("0,0.00"),
          ]);
        });
              ...
              yAxes: [
                {
                  scaleLabel: {
                    display: true,
                    labelString: "Volumen (miles de m³)",
                  },
                  ticks: {
                    min: 0,
                  },
        ...
        $("#tabla6").DataTable({
          ...
          buttons: [
            {
              extend: "excelHtml5",
              title: "Volumen (miles de m³)* por año",
              className: estiloboton,
              text: "Exportar Excel",
            },
          ],
