...
var format_Lmiteminicipal_2 = new ol.format.GeoJSON();
var features_Lmiteminicipal_2 = format_Lmiteminicipal_2.readFeatures(json_Lmiteminicipal_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Lmiteminicipal_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Lmiteminicipal_2.addFeatures(features_Lmiteminicipal_2);
var lyr_Lmiteminicipal_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Lmiteminicipal_2, 
                style: style_Lmiteminicipal_2,
                interactive: true,
                title: '<img src="styles/legend/Lmiteminicipal_2.png" /> Límite minicipal'
            });
...
var group_BajaCaliforniaSur = new ol.layer.Group({
                                layers: [lyr_GoogleSatellite_0,lyr_Lmiteestatal_1,lyr_Lmiteminicipal_2,lyr_UnidadesdeRiego_3,lyr_DistritosdeRiego_4,lyr_Municipios_5,lyr_Poblaciones_6,],
                                title: "Baja California Sur"});

lyr_GoogleSatellite_0.setVisible(true);lyr_Lmiteestatal_1.setVisible(true);lyr_Lmiteminicipal_2.setVisible(true);lyr_UnidadesdeRiego_3.setVisible(true);lyr_DistritosdeRiego_4.setVisible(true);lyr_Municipios_5.setVisible(true);lyr_Poblaciones_6.setVisible(true);
...
lyr_Lmiteminicipal_2.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'CVEGEO': 'CVEGEO', 'CVE_ENT': 'CVE_ENT', 'CVE_MUN': 'CVE_MUN', 'NOM_ENT': 'NOM_ENT', 'AREA': 'AREA', 'PERIMETER': 'PERIMETER', 'COV_': 'COV_', 'COV_ID': 'COV_ID', 'NOM_MUN': 'NOM_MUN', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
...
lyr_Lmiteminicipal_2.set('fieldImages', {'OBJECTID': 'TextEdit', 'CVEGEO': 'TextEdit', 'CVE_ENT': 'TextEdit', 'CVE_MUN': 'TextEdit', 'NOM_ENT': 'TextEdit', 'AREA': 'TextEdit', 'PERIMETER': 'TextEdit', 'COV_': 'TextEdit', 'COV_ID': 'TextEdit', 'NOM_MUN': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
...
lyr_Lmiteminicipal_2.set('fieldLabels', {});
