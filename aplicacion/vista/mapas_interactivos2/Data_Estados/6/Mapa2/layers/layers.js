...
var format_DistrirosdeRiego_3 = new ol.format.GeoJSON();
var features_DistrirosdeRiego_3 = format_DistrirosdeRiego_3.readFeatures(json_DistrirosdeRiego_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_DistrirosdeRiego_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_DistrirosdeRiego_3.addFeatures(features_DistrirosdeRiego_3);
var lyr_DistrirosdeRiego_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_DistrirosdeRiego_3, 
                style: style_DistrirosdeRiego_3,
                interactive: true,
                title: '<img src="styles/legend/DistrirosdeRiego_3.png" /> Distriros de Riego'
            });
...
var group_Colima = new ol.layer.Group({
                                layers: [lyr_GoogleSatellite_0,lyr_Lmiteestatal_1,lyr_Lmitemunicipal_2,lyr_DistrirosdeRiego_3,lyr_UnidadesdeRiego_4,lyr_Municipios_5,lyr_Poblaciones_6,],
                                title: "Colima"});

lyr_GoogleSatellite_0.setVisible(true);lyr_Lmiteestatal_1.setVisible(true);lyr_Lmitemunicipal_2.setVisible(true);lyr_DistrirosdeRiego_3.setVisible(true);lyr_UnidadesdeRiego_4.setVisible(true);lyr_Municipios_5.setVisible(true);lyr_Poblaciones_6.setVisible(true);
...
lyr_DistrirosdeRiego_3.set('fieldAliases', {'TIPO': 'TIPO', 'nom_dr': 'nom_dr', 'CVE_ENT': 'CVE_ENT', 'CVE_MUN': 'CVE_MUN', 'NOM_MUN': 'NOM_MUN', 'ENTMUN': 'ENTMUN', 'Area_ha': 'Area_ha', });
...
lyr_DistrirosdeRiego_3.set('fieldImages', {'TIPO': 'TextEdit', 'nom_dr': 'TextEdit', 'CVE_ENT': 'TextEdit', 'CVE_MUN': 'TextEdit', 'NOM_MUN': 'TextEdit', 'ENTMUN': 'TextEdit', 'Area_ha': 'TextEdit', });
...
lyr_DistrirosdeRiego_3.set('fieldLabels', {});
