...
var format_Muincipios_4 = new ol.format.GeoJSON();
var features_Muincipios_4 = format_Muincipios_4.readFeatures(json_Muincipios_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Muincipios_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Muincipios_4.addFeatures(features_Muincipios_4);
var lyr_Muincipios_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Muincipios_4, 
                style: style_Muincipios_4,
                interactive: true,
                title: '<img src="styles/legend/Muincipios_4.png" /> Muincipios'
            });
...
var group_Aguascalientes = new ol.layer.Group({
                                layers: [lyr_GoogleSatellite_0,lyr_Lmiteestatal_1,lyr_Lmitemunicipal_2,lyr_TipodeVegetacin_3,lyr_Muincipios_4,lyr_Poblaciones_5,],
                                title: "Aguascalientes"});

lyr_GoogleSatellite_0.setVisible(true);lyr_Lmiteestatal_1.setVisible(true);lyr_Lmitemunicipal_2.setVisible(true);lyr_TipodeVegetacin_3.setVisible(true);lyr_Muincipios_4.setVisible(true);lyr_Poblaciones_5.setVisible(true);
...
lyr_Muincipios_4.set('fieldAliases', {'CVEGEO': 'CVEGEO', 'CVE_ENT': 'CVE_ENT', 'CVE_MUN': 'CVE_MUN', 'NOM_ENT': 'NOM_ENT', 'AREA': 'AREA', 'PERIMETER': 'PERIMETER', 'COV_': 'COV_', 'COV_ID': 'COV_ID', 'NOM_MUN': 'NOM_MUN', });
...
lyr_Muincipios_4.set('fieldImages', {'CVEGEO': 'TextEdit', 'CVE_ENT': 'TextEdit', 'CVE_MUN': 'TextEdit', 'NOM_ENT': 'TextEdit', 'AREA': 'TextEdit', 'PERIMETER': 'TextEdit', 'COV_': 'TextEdit', 'COV_ID': 'TextEdit', 'NOM_MUN': 'TextEdit', });
...
lyr_Muincipios_4.set('fieldLabels', {});
