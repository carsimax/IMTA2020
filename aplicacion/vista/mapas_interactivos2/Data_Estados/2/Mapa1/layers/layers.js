...
var group_BajaCalifornia = new ol.layer.Group({
                                layers: [lyr_GoogleSatellite_0,lyr_Lmiteestatal_1,lyr_Lmitemunicipal_2,lyr_UnidadesdeRiego_3,lyr_Municipios_4,lyr_DistritosdeRiego_5,lyr_Poblaciones_6,],
                                title: "Baja California"});

lyr_GoogleSatellite_0.setVisible(true);lyr_Lmiteestatal_1.setVisible(true);lyr_Lmitemunicipal_2.setVisible(true);lyr_UnidadesdeRiego_3.setVisible(true);lyr_Municipios_4.setVisible(true);lyr_DistritosdeRiego_5.setVisible(true);lyr_Poblaciones_6.setVisible(true);
