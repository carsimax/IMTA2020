...
var format_UnidadesdeRiego_4 = new ol.format.GeoJSON();
var features_UnidadesdeRiego_4 = format_UnidadesdeRiego_4.readFeatures(json_UnidadesdeRiego_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_UnidadesdeRiego_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_UnidadesdeRiego_4.addFeatures(features_UnidadesdeRiego_4);
var lyr_UnidadesdeRiego_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_UnidadesdeRiego_4, 
                style: style_UnidadesdeRiego_4,
                interactive: true,
                title: '<img src="styles/legend/UnidadesdeRiego_4.png" /> Unidades de Riego'
            });
var format_DistritosdeRiego_5 = new ol.format.GeoJSON();
var features_DistritosdeRiego_5 = format_DistritosdeRiego_5.readFeatures(json_DistritosdeRiego_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_DistritosdeRiego_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_DistritosdeRiego_5.addFeatures(features_DistritosdeRiego_5);
var lyr_DistritosdeRiego_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_DistritosdeRiego_5, 
                style: style_DistritosdeRiego_5,
                interactive: true,
                title: '<img src="styles/legend/DistritosdeRiego_5.png" /> Distritos de Riego'
            });
...
var group_BajaCalifornia = new ol.layer.Group({
                                layers: [lyr_GoogleSatellite_0,lyr_Lmiteestatal_1,lyr_Lmitemunicipal_2,lyr_Municipios_3,lyr_UnidadesdeRiego_4,lyr_DistritosdeRiego_5,lyr_Poblaciones_6,],
                                title: "Baja California"});

lyr_GoogleSatellite_0.setVisible(true);lyr_Lmiteestatal_1.setVisible(true);lyr_Lmitemunicipal_2.setVisible(true);lyr_Municipios_3.setVisible(true);lyr_UnidadesdeRiego_4.setVisible(true);lyr_DistritosdeRiego_5.setVisible(true);lyr_Poblaciones_6.setVisible(true);
...
lyr_Municipios_3.set('fieldAliases', {'CVEGEO': 'CVEGEO', 'CVE_ENT': 'CVE_ENT', 'CVE_MUN': 'CVE_MUN', 'NOM_ENT': 'NOM_ENT', 'AREA': 'AREA', 'PERIMETER': 'PERIMETER', 'COV_': 'COV_', 'COV_ID': 'COV_ID', 'NOM_MUN': 'NOM_MUN', });
lyr_UnidadesdeRiego_4.set('fieldAliases', {'TIPO': 'TIPO', 'nom_dtt': 'nom_dtt', 'nom_dr': 'nom_dr', 'CVE_ENT': 'CVE_ENT', 'CVE_MUN': 'CVE_MUN', 'NOM_MUN': 'NOM_MUN', 'ENTMUN': 'ENTMUN', 'Area_ha': 'Area_ha', });
lyr_DistritosdeRiego_5.set('fieldAliases', {'TIPO': 'TIPO', 'nom_dr': 'nom_dr', 'CVE_ENT': 'CVE_ENT', 'CVE_MUN': 'CVE_MUN', 'NOM_MUN': 'NOM_MUN', 'ENTMUN': 'ENTMUN', 'Area_ha': 'Area_ha', });
...
lyr_Municipios_3.set('fieldImages', {'CVEGEO': 'TextEdit', 'CVE_ENT': 'TextEdit', 'CVE_MUN': 'TextEdit', 'NOM_ENT': 'TextEdit', 'AREA': 'TextEdit', 'PERIMETER': 'TextEdit', 'COV_': 'TextEdit', 'COV_ID': 'TextEdit', 'NOM_MUN': 'TextEdit', });
lyr_UnidadesdeRiego_4.set('fieldImages', {'TIPO': 'TextEdit', 'nom_dtt': 'TextEdit', 'nom_dr': 'TextEdit', 'CVE_ENT': 'TextEdit', 'CVE_MUN': 'TextEdit', 'NOM_MUN': 'TextEdit', 'ENTMUN': 'TextEdit', 'Area_ha': 'TextEdit', });
lyr_DistritosdeRiego_5.set('fieldImages', {'TIPO': 'TextEdit', 'nom_dr': 'TextEdit', 'CVE_ENT': 'TextEdit', 'CVE_MUN': 'TextEdit', 'NOM_MUN': 'TextEdit', 'ENTMUN': 'TextEdit', 'Area_ha': 'TextEdit', });
...
lyr_UnidadesdeRiego_4.set('fieldLabels', {});
lyr_DistritosdeRiego_5.set('fieldLabels', {});
