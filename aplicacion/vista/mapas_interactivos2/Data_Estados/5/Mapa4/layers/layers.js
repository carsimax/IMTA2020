...
lyr_TiposdeVegetacin_3.set('fieldAliases', {'TIP_INFO': 'TIP_INFO', 'CLAVE': 'CLAVE', 'TIP_ECOV': 'TIP_ECOV', 'TIP_VEG': 'TIP_VEG', 'DESVEG': 'DESVEG', 'FASE_VS': 'FASE_VS', 'OTROS': 'OTROS', 'CAL_POS': 'CAL_POS', 'USV': 'USV', });
lyr_Municipios_4.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'CVEGEO': 'CVEGEO', 'CVE_ENT': 'CVE_ENT', 'CVE_MUN': 'CVE_MUN', 'NOM_ENT': 'NOM_ENT', 'AREA': 'AREA', 'PERIMETER': 'PERIMETER', 'COV_': 'COV_', 'COV_ID': 'COV_ID', 'NOM_MUN': 'NOM_MUN', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
...
lyr_TiposdeVegetacin_3.set('fieldImages', {'TIP_INFO': 'TextEdit', 'CLAVE': 'TextEdit', 'TIP_ECOV': 'TextEdit', 'TIP_VEG': 'TextEdit', 'DESVEG': 'TextEdit', 'FASE_VS': 'TextEdit', 'OTROS': 'TextEdit', 'CAL_POS': 'TextEdit', 'USV': 'TextEdit', });
lyr_Municipios_4.set('fieldImages', {'OBJECTID': 'TextEdit', 'CVEGEO': 'TextEdit', 'CVE_ENT': 'TextEdit', 'CVE_MUN': 'TextEdit', 'NOM_ENT': 'TextEdit', 'AREA': 'TextEdit', 'PERIMETER': 'TextEdit', 'COV_': 'TextEdit', 'COV_ID': 'TextEdit', 'NOM_MUN': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
