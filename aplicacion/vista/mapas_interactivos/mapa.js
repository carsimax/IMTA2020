...
function CambiarMapa() {
    ...
    $("#download_mapa_1").append("<a href='./mapas/" + estado + ".jpg' download='Superficie Agrícola de Riego estado de " + estado + "' class='btn btn-gob' style='color: white;'><span><i class='fas fa-arrow-down'></i></span> Descargar infografía</a>");
...
function Mapa2() {
    ...
    $("#download_mapa_2").append("<a href='./mapas/" + estado + "_2.jpg' download='Principales Cultivos Agrícolas de Volumen de Riego estado de " + estado + "' class='btn btn-gob' style='color: white;'><span><i class='fas fa-arrow-down'></i></span> Descargar infografía</a>");
...
function Mapa3() {
    ...
    $("#download_mapa_3").append("<a href='./mapas/" + estado + "_3.jpg' download='Fuentes de Abastecimiento de Agua de Riego estado de " + estado + "' class='btn btn-gob' style='color: white;'><span><i class='fas fa-arrow-down'></i></span> Descargar infografía</a>");
...
function Mapa4() {
    ...
    $("#download_mapa_4").append("<a href='./mapas/" + estado + "_4.jpg' download='Tipos de Vegetación estado de " + estado + "' class='btn btn-gob' style='color: white;'><span><i class='fas fa-arrow-down'></i></span> Descargar infografía</a>");
...
function Mapa5() {
    ...
    $("#download_mapa_5").append("<a href='./mapas/" + estado + "_5.jpg' download='Condigicón de los Suelos estado de " + estado + "' class='btn btn-gob' style='color: white;'><span><i class='fas fa-arrow-down'></i></span> Descargar infografía</a>");
