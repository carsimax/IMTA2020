            ...
            <div class="col-sm">
                <div class="row">
                    <div class="col-sm">
                        ...
                        <a href="/formatos/FormatoEstacionesClimatologicas.php" class="btn btn-warning btn-fill  btn-block">Descargar
                            Formato</a>
                        <br>
                        ...
                        <ul class="container">
                            ...
                            <li><p>Favor de escribir el nombre del Estado y Municipio como se encuentran registrados en la base de datos.</p></li>
                        ...
                        <form action="" method="POST" id="formUpload"  enctype="multipart/form-data">
                            <input type="text" hidden id="Accion" name="Accion" value="EstacionClimatologica">
    ...
    $(function () {
        $("#formUpload").on("submit", function (e) {
            ...
            $.ajax({
                ...
                if (res == 'OK') {
                    buenTrabajoNuevo('EstacionesClimatologicas');
                } else {
                    algoAndaMal(res);
                }
            });
