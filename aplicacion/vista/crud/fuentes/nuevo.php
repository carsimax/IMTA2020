            ...
            <div class="pt-3 pb-2 mb-3 border-bottom">
                <nav aria-label="breadcrumb ">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Nueva Fuente</li>
                    </ol>
                </nav>
            </div>
            <div class="col-sm">
                <div class="row">
                    <div class="col-sm">
                        <form action="" name="formFuente" onsubmit="valiFormNuevo('/aplicacion/controlador/fuente.php',$('form').serialize(),'Fuentes'); return false">
