...
<div class="row">
    <div class="col-sm">
        <a href="fuentes/nuevo.php" class="btn btn-gob btn-fill  btn-block"><i class="fas fa-plus"></i> Nueva Fuente</a>
    </div>
</div>
<hr>
<div class="row">
...
<script>
    ...
    $.ajax({
        type: "POST",
        url: "/aplicacion/controlador/fuente.php",
        data: cadena,
        ...
        success: function (resp) {
            ...
            $.each(JSON.parse(resp), function (index, item) {
                data.push([item.id_fuente, item.nombre])
            });
    ...
    $('#example').on('click', '#editar', function () {
        ...
        $.redirect("/aplicacion/vista/crud/fuentes/editar.php", {ID: data[0]}, "POST");
    });
