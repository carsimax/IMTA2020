...
<div class="row">
    <div class="col-sm">
        <a href="ciclos/nuevo.php" class="btn btn-gob btn-fill  btn-block"><i class="fas fa-plus"></i> Nuevo Ciclo</a>
    </div>
</div>
<hr>
<div class="row">
...
<script>
    ...
    $.ajax({
        type: "POST",
        url: "/aplicacion/controlador/ciclo.php",
        data: cadena,
        ...
        success: function (resp) {
            ...
            $.each(JSON.parse(resp), function (index, item) {
                data.push([item.id_ciclo, item.nombre, item.siglas, item])
            });
     ...
     $('#example').on('click', '#editar', function () {
        ...
        $.redirect("/aplicacion/vista/crud/ciclos/editar.php", {ID: data[0]}, "POST");
    });
                        ...
                        if (response == 1) {
                            Swal.fire({
                                ...
                                confirmButtonColor: '#621132'
                                    ...
                                    .then((value) => {
                                        $.redirect("/aplicacion/vista/crud/dbadmin.php", {tablaP: "Ciclos"}, "POST");
                                    });
                        }
                    },
                });
