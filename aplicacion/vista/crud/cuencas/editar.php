...
$Cuenca = new Cuenca();
$Cuenca = $Cuenca->getCuenca($_POST['ID']);
?>
                ...
                <div class="row">
                    <div class="col-sm">
                        <form action="" name="formPropietario" onsubmit="valiFormNuevo('/aplicacion/controlador/cuenca.php',$('form').serialize(),'Cuencas'); return false">
                            ...
                            <div class="col-sm">
                                <p>ID Cuenca:</p>
                                <input name="id_cuenca" id="id_cuenca" type="number"
                                       value="<?php echo $Cuenca->getIdCuenca() ?>" hidden>
                                <input disabled type="number" class="form-control"
                                       value="<?php echo $Cuenca->getIdCuenca() ?>" required>
                            </div>
                            <div class="col-sm">
                                <p>Nombre Cuenca:</p>
                                <input type="text" class="form-control" name="nombre" id="nombre"
                                       value="<?php echo $Cuenca->getNombre() ?>" required>
                            </div>
                            <div class="col-sm">
                                ...
                                <select class="form-control" name="reg_hidrologica_id" id="reg_hidrologica_id" required>
                                    ...
                                    foreach ($Regiones as $Region) {
                                        if ($Cuenca->getRegHidrologicaId() == $Region['id_reg_hidrologica']) {
                                            ?>
                                            <option selected
                                                    value="<?php echo $Region['id_reg_hidrologica']; ?>"><?php echo $Region['nombre']; ?></option>
                                                    <?php
                                                } else {
                                                    ?>
