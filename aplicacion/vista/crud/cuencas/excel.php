            ...
            <div class="col-sm">
                <div class="row">
                    <div class="col-sm">
                            ...
                            <p>Para que el proceso de importación de cuencas a la base de datos se realice de forma correcta
                                le recomendamos descargar el formato para los acampos correspondientes a los cuencas</p>
                            <a href="/formatos/FormatoCuenca.php" class="btn btn-warning btn-fill  btn-block">Descargar
                                Formato Cuencas</a>
                            <br>
                            <p><b>Notas importantes:</b></p>
                            <ul class="container">
                                <li><p>La primera hoja corresponde a la información general de las cuencas, los campos ya tienen
                                        el formato adecuado, favor de no modificar las cabeceras ni el tipo de dato.</p></li>
                                <li><p>Si se coloca el ID de una cuenca ya existente en la base de datos, el sistema solamente
                            ...
                            <form action="/aplicacion/controlador/excel.php" method="POST" enctype="multipart/form-data">
                                <input type="text" hidden id="Accion" name="Accion" value="Cuenca">
