    ...
    <div class="row">
        <main role="main" class="col-md-12 ml-sm-auto col-lg-12 px-md-4">
            ...
            <div class="col-sm">
                <div class="row">
                    <div class="col-sm">
                        <p>Para que el proceso de importación de los datos de marginación por municipio a la base de datos se realice de forma correcta
                            le recomendamos descargar el siguiente formato que contiene los campos correspondientes en la base de datos.</p>
                        <a href="/formatos/FormatoMarginacionMunicipio.php" class="btn btn-warning btn-fill  btn-block">Descargar
                            Formato</a>
                        <br>
                        <p><b>Notas importantes:</b></p>
                        <ul class="container">
                            <li><p>La primera hoja corresponde a la información marginal de cada municipio, los campos ya tienen
                                    el formato adecuado, favor de no modificar las cabeceras ni el tipo de dato.</p></li>
                            <li><p>Favor de escribir correctamente el nombre del Estado y Municipio.</p></li>
                            <li><p>Si se coloca un registro con un año y municipio ya existente en la base de datos, <b>el sistema
                        ...
                        <form action="" method="POST" id="formUpload"  enctype="multipart/form-data">
                            <input type="text" hidden id="Accion" name="Accion" value="MarginacionMunicipio">
                                        ...
                                        $(function () {
                                            $("#formUpload").on("submit", function (e) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    if (res == 'OK') {
                                                        buenTrabajoNuevo('MunicipioMarginacion');
                                                    } else {
                                                        algoAndaMal(res);
                                                    }
                                                });
