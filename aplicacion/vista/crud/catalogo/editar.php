        ...
        <main role="main" class="col-md-12 ml-sm-auto col-lg-12 px-md-4">
            ...
            <div class="col-sm">
                <form action="" name="formRegistro" onsubmit="valiFormNuevo(); return false">
                    <div class="row">
                        <input type="number" hidden id="idRegistro" name="idRegistro" value="<?php echo $_POST['ID'] ?>">
                        <input type="text" hidden id="Accion" name="Accion" value="Editar">
                        <div class="col-sm">
                            <p class="mb-1">Fuente:</p>
                            <input type="text" class="form-control" name="fuente" id="fuente" required value="<?php echo $Catalogo->getFuente() ?>">
                        </div>
                        <div class="col-sm">
                            <p class="mb-1">URL:</p>
                            <input type="text" class="form-control" name="url" id="url" required value="<?php echo $Catalogo->getUrl() ?>">
                        </div>
                        <div class="col-sm">
                            <p class="mb-1">Fecha:</p>
                            <input type="date" class="form-control" name="fecha" id="fecha" required value="<?php echo $Catalogo->getFecha() ?>">
                        </div>
                        <div class="col-sm">
                            <p class="mb-1">Año al que corresponde esta fuente:</p>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <p class="mb-1">Cita en APA WEB:</p>
                            <input type="text" class="form-control" name="cita" id="cita" required value="<?php echo $Catalogo->getCita() ?>">
                        </div>

                        <div class="col-sm">
                            <p class="mb-1">Módulo de consulta dónde se utiliza esta fuente:</p>
                            <select class="form-control" name="modulo_id" id="modulo_id">
                                <?php
                                foreach ($modulos as $modulo) {
                                    if ($modulo['id_modulo'] == $Catalogo->getModulo_id()) {
                                ?>
                                        <option selected value=" <?php echo $modulo['id_modulo']; ?>"><?php echo $modulo['nombre']; ?></option>
                                    <?php
                                    } else {
                                    ?>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <textarea class="form-control" id="descripcion" name="descripcion" rows="3"><?php echo $Catalogo->getDescripcion() ?></textarea>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
