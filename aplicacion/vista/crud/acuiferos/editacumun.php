...
$Acuifero = $Acuifero->getAcuiferoMun($_POST['Acuifero_ID'], $_POST['Municipio_ID']);
        ...
        <main role="main" class="col-md-12 ml-sm-auto col-lg-12 px-md-4">
            ...
            <div class="col-sm">
                <form action="" name="formAcuMun" onsubmit="valiFormMun(); return false">
                    <input hidden disabled type="text" id="ID_OLD" name="ID_OLD"
                        value="<?php echo $Acuifero->getMunicipioID() ?>">
                    <div class="row">
                        <div class="col-sm">
                            <p>ID Acuífero:</p>
                            <input disabled type="number" class="form-control" name="Acuifero_ID" id="Acuifero_ID"
                                required value="<?php echo $Acuifero->getAcuiferoID() ?>">
                        </div>
                        <div class="col-sm">
                            <p>Municipio:</p>
                        ...
                        foreach ($Municipios as $Municipio) {
                            if ($Municipio['id_municipio'] == $Acuifero->getMunicipioID()) {
                                ?>
                                <option selected value="<?php echo $Municipio['id_municipio']; ?>">
...
<form id="AcuForm" action="editar.php" method="post" hidden>
    <input name="ID" type="text" value="<?php echo $_POST['Acuifero_ID'] ?>" hidden>
</form>
