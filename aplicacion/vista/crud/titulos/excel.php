    ...
    <div class="row">
        <main role="main" class="col-md-12 ml-sm-auto col-lg-12 px-md-4">
            ...
            <div class="col-sm">
                <div class="row">
                    <div class="col-sm">
                        <p>Para que el proceso de importación de títulos a la base de datos se realice de forma correcta
                            le recomendamos descargar el formato para los acampos correspondientes a los títulos</p>
                        <a href="/formatos/FormatoTitulo.php" class="btn btn-warning btn-fill  btn-block">Descargar
                            Formato título</a>
                        <br>
                        <p><b>Notas importantes:</b></p>
                        <ul class="container">
                            <li><p>La primera hoja corresponde a la información general de los títulos, los campos ya tienen
                                    el formato adecuado, favor de no modificar las cabeceras ni el tipo de dato.</p></li>
                            <li><p>Si se coloca el ID de un título ya existente en la base de datos, el sistema solamente
                        ...
                        <form action="" method="POST" id="formUpload"  enctype="multipart/form-data">
                            <input type="text" hidden id="Accion" name="Accion" value="Titulo">
